...
int main(int argc, char** argv)
{
    ...
    std::string pointcloud_topic, image_topic, camera_info_topic, pointcloud_output_topic, image_output_topic, camera_info_output_topic;
    ...
    nh.getParam("camera_info_output_topic", camera_info_output_topic);
    ...
    message_filters::Subscriber<sensor_msgs::CameraInfo> camera_info_sub(nh, camera_info_topic, 1);
    ...
    camera_info_pub = nh.advertise<sensor_msgs::CameraInfo>(camera_info_output_topic, 1);

    // Create synchronizer to synchronize the input topics
    typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::PointCloud2, sensor_msgs::CompressedImage, sensor_msgs::CameraInfo> MySyncPolicy;
    message_filters::Synchronizer<MySyncPolicy> sync(MySyncPolicy(100), pointcloud_sub, image_sub, camera_info_sub);
