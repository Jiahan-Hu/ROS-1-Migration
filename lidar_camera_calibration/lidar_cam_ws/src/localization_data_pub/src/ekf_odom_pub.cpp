...
const double TICKS_PER_REVOLUTION = 420; // For reference purposes. (modified)
const double WHEEL_RADIUS = 0.248/2; // Wheel radius in meters (modified)
const double WHEEL_BASE = 0.632; // Center of left tire to center of right tire (modified)
const double TICKS_PER_METER = 540;// 526; // Original was 2800 (need to modify)
