...
class mist_generator():
    ...
    def minimum_snap_2d(self,waypts,ts,v0,a0,ve,ae):
        ...
        """
        polys_x,self.Q_x,self.px = self.minimum_snap_single(waypts[0],ts,v0[0],a0[0],ve[0],ae[0])
        polys_y,self.Q_y,self.py = self.minimum_snap_single(waypts[1],ts,v0[1],a0[1],ve[1],ae[1])
