...
public:
    FusionBbxTransformer() : nh("~") {
        ...
        nh.param<std::string>("fusion_bbx_topic", fusion_bbx_topic, "/tracking/fusion_bbx_score_header");
        ...
        nh.param<std::string>("transformed_bbx_topic", transformed_bbx_topic, "/tracking/transformed_fusion_bbx_score_header");
...
class FusionBbxTransformer {
public:
    FusionBbxTransformer() : nh("~"), tf_listener(std::make_shared<tf2_ros::TransformListener>(tf_buffer)) {
...
private:
    ...
    ros::Publisher transformed_bbx_header_pub;
    tf2_ros::Buffer tf_buffer;
    std::shared_ptr<tf2_ros::TransformListener> tf_listener;  // Using smart pointer
};
