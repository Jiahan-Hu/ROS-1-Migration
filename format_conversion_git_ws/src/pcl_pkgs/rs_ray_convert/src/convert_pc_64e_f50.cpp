...
void cloud_cb_sp (const sensor_msgs::PointCloud2ConstPtr& cloud_msg)
{
    ...
    new_cloud.header = cloud.header;
    new_cloud.height = cloud.height;
    new_cloud.width = 50; //cloud.width;

    // keep the intensity value in the new cloud
    new_cloud.is_dense = false;

    // Iterate through the original cloud and select desired lines based on a specific criterion
    // map the 128 line to fake 64 line (50)
    
    for (int i = 0; i < cloud.width; i++) {
        
        // if i in [1, 2, 3, 4, 5, 6, 7, 8, 9, 13, 14, 15, 20, 21, 24, 26, 27, 29, 31, 33, 34, 36, 38, 41, 43, 44, 45, 48, 50, 51, 55, 57, 60, 61, 62, 67, 69, 71, 72, 74, 78, 79, 81, 84, 85, 88, 91, 95, 97, 102] - 1 
        if (i == 0 || i == 1 || i == 2 || i == 3 || i == 4 || i == 5 || i == 6 || i == 7 || i == 8 || i == 12 || i == 13 || i == 14 || i == 19 || i == 20 || i == 23 || i == 25 || i == 26 || i == 28 || i == 30 || i == 32 || i == 33 || i == 35 || i == 37 || i == 40 || i == 42 || i == 43 || i == 44 || i == 47 || i == 49 || i == 50 || i == 54 || i == 56 || i == 59 || i == 60 || i == 61 || i == 66 || i == 68 || i == 70 || i == 71 || i == 73 || i == 77 || i == 78 || i == 80 || i == 83 || i == 84 || i == 87 || i == 90 || i == 94 || i == 96 || i == 101) {
            for (int j = 0; j < cloud.height; j++) {
