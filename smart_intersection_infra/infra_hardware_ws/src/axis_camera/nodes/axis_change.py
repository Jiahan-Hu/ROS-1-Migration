...
class StreamThread(threading.Thread):
    def __init__(self, axis):
        ...
        rospy.Subscriber(gps_time_topic, TimeReference, self.gps_time_callback)
        self.gps_time = TimeReference()
    ...
    def publishMsg(self):
        ...
        if self.axis.use_gps_time:
            self.msg.header.stamp = self.gps_time.time_ref
        else:
...
class Axis:
    def __init__(self, hostname, username, password, width, height, frame_id, 
                 camera_info_url, use_encrypted_password, camera,use_gps_time):
