...
private:
  ...
  ros::Publisher publisher_markers_ToLabels;
  ros::Publisher publisher_markers_ToArrows;
  ros::Publisher publisher_markers_ToBoxes;
  ros::Publisher publisher_markers_ToModels;
  ros::Publisher publisher_markers_ToHulls;
  ros::Publisher publisher_markers_ToCentroids;
