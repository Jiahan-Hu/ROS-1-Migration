...
public:
  ...
  bool _velodyne_transform_available;
  ...
  bool _remove_ground;  // only ground
  ...
  void publishCloudClusters(const ros::Publisher *in_publisher, const autoware_msgs::CloudClusterArray &in_clusters,
                          const std::string &in_target_frame, const std_msgs::Header &in_header,
                          autoware_msgs::DetectedObjectArray &objects_euclidean_);
  ...
  void publishDetectedObjects(const autoware_msgs::CloudClusterArray &in_clusters,autoware_msgs::DetectedObjectArray &objects_euclidean_);

  void lidar_cluster(pcl::PointCloud<PointT>::Ptr cloud, autoware_msgs::DetectedObjectArray &objects_euclidean_);
