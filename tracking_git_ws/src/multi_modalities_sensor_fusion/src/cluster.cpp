...
{
  // std::cout<<"test set cloud"<<std::endl;
  label_ = in_label;
  id_ = in_id;
  r_ = in_r;
  g_ = in_g;
  ...
  // std::cout<<"in_cluster_indices size= "<<in_cluster_indices.size()<<std::endl;
  // std::cout<<"in_origin_cloud_ptr size= "<<in_origin_cloud_ptr->points.size()<<std::endl;
