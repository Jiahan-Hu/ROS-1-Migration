...
void OnSegmentClouds(const autosense_msgs::PointCloud2ArrayConstPtr &segments_msg) 
{
    ...
    */
    ...
    // topic name: /tracking/object_fusion_box_score
    autosense::common::publishObjectsMarkersFusionBoxScore(tracking_objects_fusion_box_score_pub_, header,
                                             box_color,
                                             tracking_objects_velo, detector_objects_);  

    // topic name: /tracking/object_fusion_score_label
    autosense::common::publishObjectsMarkersFusionBoxScoreLabel(tracking_objects_fusion_score_label_pub_, header,
                                             box_color,
                                             tracking_objects_velo, detector_objects_);  

    // topic name: "/tracking/objects_header_box_score"    
    autosense::common::publishObjectsMarkersFusionBoxScore_header(tracking_objects_header_box_score_pub_, header,
                                             box_color,
                                             tracking_objects_velo,detector_objects_);

    // topic name: /tracking/objects_header_bbx_score_label
    autosense::common::publishObjectsMarkersBoxScoreLabel_header(tracking_objects_header_box_score_label_pub_, header,
                                             box_color,
                                             tracking_objects_velo,detector_objects_);
...
int main(int argc, char **argv) {
    ...
    std::string pub_tracking_objects_header_box_score_label_topic,pub_tracking_objects_header_box_score_topic,
