...
ros::Publisher tracking_objects_header_box_score_pub_;
...
void OnSegmentClouds(const autosense_msgs::PointCloud2ArrayConstPtr &segments_msg) 
{
    ...
    // topic name: /tracking/objects_box_score_header    
...
int main(int argc, char **argv) {
    ...
    std::string pub_tracking_objects_header_box_score_topic,pub_tracking_objects_fusion_box_score_topic,
