...
/*
 ...
 Authors: Yuki KITSUKAWA; Letian Gao
 */
#define SAVEDATA 0
#define SAVEDATA_datasetprocess 1
...
static std::string map_pcd_file_name = "/home/jiaqi/v2v_5m.pcd";
...
Eigen::Vector3d xyz_lever(0, 0, 0),ndt_xyz(0,0,0),ndt_xyz_pre(0,0,0);
...
static void rs_callback(const sensor_msgs::PointCloud2ConstPtr& input_lidar) //0312 datacollection pretest
{
...
int main(int argc, char** argv)
{
  ...
  if (SAVEDATA_datasetprocess)
  {
    outdata_datasetprocessing_.open("/home/jiaqi/ros_ws/localization_ws/src/20241118.txt", std::ios::app | std::ios::out);
  }
  ...
  // static std::string map_pcd_file_name = "/home/jiaqi/catkin_ws_glt/v2v_5m.pcd";
  ...
  private_nh.getParam("map_file_path", map_pcd_file_name);
...
*/
  ...
  ndt_final_cloud_pub = nh.advertise<sensor_msgs::PointCloud2>("/ndt_final_cloud", 10);
  kf_PoseError_pub = nh.advertise<geometry_msgs::PoseStamped>("/kf_PoseError", 10);
  gnss_localframe_pub = nh.advertise<geometry_msgs::PoseStamped>("/gnss_localframe", 10);
  // Subscribers
  ...
  //}
  ros::Subscriber gps_raw_sub = nh.subscribe("/gps/raw", 1,gps_raw_callback);
  ros::Subscriber novatel_inspva_sub = nh.subscribe("/veh1/novatel/oem7/inspva", 1,novatel_inspva_callback);
