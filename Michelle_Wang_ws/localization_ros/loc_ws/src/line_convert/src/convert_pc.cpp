...
void cloud_cb_sp (const sensor_msgs::PointCloud2ConstPtr& cloud_msg)
{
    ...
    for (int i = 0; i < cloud.width; i++) {
        ...
        if (i == 0 || i == 3 || i == 4 || i == 5 || i == 13 || i == 20 || i == 26 || i == 28 || i == 33 || i == 40 || i == 43 || i == 44 || i == 50 || i == 54 || i == 56 || i == 61 || i == 66 || i == 68 || i == 71 || i == 73 || i == 78 || i == 80 || i == 83 || i == 84 || i == 90 || i == 94 || i == 96 || i == 106 || i == 115 || i == 122 || i == 123) {
            
            for (int j = 0; j < cloud.height; j++) {
                // push back the point to the perticular line of new_cloud
                // pcl::PointXYZI p=cloud.at(i,j);
                // ROS_INFO("ii: %d", ii);
                // ROS_INFO("j: %d", j);
                // new_cloud.at(ii,j)=p;
                new_cloud.push_back(cloud.at(i,j));
    ...
    ROS_INFO("new_cloud.width: %d", new_cloud.width);
    ROS_INFO("new_cloud.height: %d", new_cloud.height);
