...
### Run multiple zed cam

For camera 1: 

```
roslaunch zed_wrapper zed2i.launch node_name:=zed_node1 camera_name:=zed2i_1 camera_id:=0
```

For camera 2: 

```
roslaunch zed_wrapper zed2i.launch node_name:=zed_node2 camera_name:=zed2i_2 camera_id:=1
```
